  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-violet-600 to-indigo-600 blur-lg opacity-50 group-hover:opacity-80 transition-opacity"></div>
              <div className="relative bg-gradient-to-br from-violet-600 to-indigo-600 p-2.5 rounded-xl group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            {user ? (
              ...
              <>
                ...
                <Link 
                  href="/generate" 
                  className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-semibold rounded-xl hover:opacity-90 transition-all hover:scale-105"
                >
        ...
        {/* Mobile Menu */}
        {isOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-[#030014]/95 backdrop-blur-xl border-b border-white/5 animate-fade-in">
            <div className="p-6 space-y-4">
              ...
              {user ? (
                <>
                  <Link
                    href="/dashboard"
                    className="block py-3 px-4 text-violet-400 hover:bg-white/5 rounded-xl transition-colors"
                    onClick={() => setIsOpen(false)}
                  >
                    Dashboard
                  </Link>
                ...
                <>
                  ...
                  <Link 
                    href="/generate" 
                    className="block py-4 bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-semibold rounded-xl text-center"
                    onClick={() => setIsOpen(false)}
                  >
                    Prova Gratis
                  </Link>
